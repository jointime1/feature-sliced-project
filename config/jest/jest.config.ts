...
export default {
    ...
    // cacheDirectory: "C:\\Users\\joint\\AppData\\Local\\Temp\\jest",
    ...
    // The maximum amount of workers used to run your t
    // ests. Can be specified as % or a number.
    ...
    // /strings that are matched against all test paths, matched tests are skipped
    ...
    // TODO: падали тесты из-за аксиоса
